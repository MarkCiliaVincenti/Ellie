...
namespace Ellie.Tests
{
    ...
    {
        private const string responsesPath = "../../../../Ellie/data/strings/responses";
        private const string commandsPath = "../../../../data/strings/commands";
        private const string aliasesPath = "../../../../Ellie/data/aliases.yml";
