            ...
            ins =>
            {
                var eb = _eb.Create(ctx)
                            ...
                            .AddField("Required Tier",
                                $"[{ins.RequiredTier.ToFullName()}](https://patreon.com/join/Ellie)",
                                true);
        ...
        try
        {
            ...
            var eb = _eb.Create()
                        ...
                        .WithDescription(
                            ...
                            + "You can visit <https://www.patreon.com/join/Ellie> to see rewards for your tier. 🎉")
...
*- You can check your benefits on <https://www.patreon.com/join/Ellie>*
...
*- Permission guide can be found here if you're not familiar with it: <https://Ellie.readthedocs.io/en/latest/permissions-system/>*",
                            isInline: false)
