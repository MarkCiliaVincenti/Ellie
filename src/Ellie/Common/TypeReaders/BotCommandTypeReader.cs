...
public sealed class CommandOrCrTypeReader : EllieTypeReader<CommandOrCrInfo>
{
    private readonly CommandService _cmds;
    private readonly CommandHandler _commandHandler;
    private readonly EllieExpressionsService _exprs;

    public CommandOrCrTypeReader(CommandService cmds, EllieExpressionsService exprs, CommandHandler commandHandler)
    {
        _cmds = cmds;
        _exprs = exprs;
